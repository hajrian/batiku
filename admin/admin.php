                        ...
                        while($array = mysqli_fetch_array($query)){
                          echo '
                            <tr>
                              ...
                              <td class="edit"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal'.$array['idProduk'].'"><i class="glyphicon glyphicon-pencil"></i></button></td>
                              <td class="hapus"><a href="proses/hapusBarang.php?idProduk='.$array['idProduk'].'">
                                <button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></button>
                              </a></td>
                            </tr>
                          ';
